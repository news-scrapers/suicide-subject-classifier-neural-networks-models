...
class Cleaner:
    ...
    def create_tokenizer_and_clean(self):
        filename1 = "../data/extracted_tweets/no_suicide_tweets.json"
        filename2 = "../data/extracted_tweets/suicide_tweets.json"
        ...
        print(self.df)
        self.df.to_json("../data/extracted_tweets/large-bundle-clean.json",orient='records', force_ascii=False)
